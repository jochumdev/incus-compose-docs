...
leafwiki_updated_at: "2026-08-06T07:11:18.249759374Z"
...
```mermaid
flowchart TD
    C[a client on your network] --> DP["dnscrypt-proxy<br/>10.138.32.2"]
    DP -->|the local zone| P["pdns<br/>10.138.32.3"]
    DP -->|everything else| PUB["public resolvers<br/>over DNSCrypt / DoH"]

    P --> DB[(mariadb)]
    ADM["pdns-admin<br/>10.138.32.4"] --> DB
    DW[dnsweaver] -->|watches instances| INC[the Incus API]
    DW -->|creates and deletes records| P
```
